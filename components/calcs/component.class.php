...
class component_calcs extends component_base{
    ...
    function add_form_elements(&$mform,$components) {
        ...
        if ($this->config->type != 'sql') {
            ...
            require_once($CFG->dirroot.'/report/configreports/reports/'.$this->config->type.'/report.class.php');
        ...
        $mform->addElement('select', 'column', get_string('column','report_configreports'), $options);    
