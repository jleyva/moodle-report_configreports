 ...
 */
    ...
    if (! $report = $DB->get_record('report_configreports',array('id' => $reportid)))
    ...
    if (!$reportclass->check_permissions($USER->id, $context)) {
        ...
        if (!empty($graphs)) {
            ...
            if ($g['id'] == $id) {
                ...
                // Standard inclusions   
                include($CFG->dirroot."/report/configreports/lib/pChart/pData.class");
                include($CFG->dirroot."/report/configreports/lib/pChart/pChart.class");
